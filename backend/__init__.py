...
def create_app():
    ...
    def ensure_min_schema():
        ...
        stmts = [
            ...
            text('ALTER TABLE training_module ADD COLUMN IF NOT EXISTS video_url VARCHAR(500)'),
            text('ALTER TABLE training_module ADD COLUMN IF NOT EXISTS attachment_path VARCHAR(255)'),
            text('ALTER TABLE training_module ADD COLUMN IF NOT EXISTS duration_minutes INTEGER DEFAULT 10'),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS difficulty_level VARCHAR(50) DEFAULT 'intermediario'"),
            text('ALTER TABLE training_course ADD COLUMN IF NOT EXISTS workload_hours FLOAT DEFAULT 1.0'),
            text('ALTER TABLE training_course ADD COLUMN IF NOT EXISTS xp_reward INTEGER DEFAULT 100'),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS target_team_ids VARCHAR(255) DEFAULT ''"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_title VARCHAR(200) DEFAULT 'CERTIFICADO DE CAPACITAÇÃO TÉCNICA'"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_subtitle VARCHAR(300) DEFAULT 'concluiu com aproveitamento e total conformidade técnica o treinamento operacional de:'"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_style VARCHAR(50) DEFAULT 'classic'"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_signature_role VARCHAR(255) DEFAULT 'Coordenação Técnica & Operações'"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_issuer_name VARCHAR(255) DEFAULT ''"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_validity_months INTEGER DEFAULT 0"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_logo_path TEXT DEFAULT ''"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_company_name VARCHAR(255) DEFAULT ''"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_legal_text TEXT DEFAULT 'Válido exclusivamente para fins de capacitação interna e procedimentos operacionais da empresa.'"),
            text("ALTER TABLE training_course ADD COLUMN IF NOT EXISTS cert_standard TEXT DEFAULT 'Norma Interna de Qualidade & Procedimento Operacional Padrão'"),
            text("ALTER TABLE training_course ALTER COLUMN cert_logo_path TYPE TEXT"),
            text("ALTER TABLE training_course ALTER COLUMN cert_legal_text TYPE TEXT"),
            text("ALTER TABLE training_course ALTER COLUMN cert_standard TYPE TEXT"),
            text("ALTER TABLE training_course ALTER COLUMN cert_title TYPE VARCHAR(500)"),
            text("ALTER TABLE training_course ALTER COLUMN cert_subtitle TYPE TEXT"),
            text("ALTER TABLE training_course ALTER COLUMN cert_signature_role TYPE VARCHAR(255)"),
            text("ALTER TABLE training_course ALTER COLUMN cert_issuer_name TYPE VARCHAR(255)"),
            text("ALTER TABLE training_course ALTER COLUMN cert_company_name TYPE VARCHAR(255)"),
            text('ALTER TABLE training_question ADD COLUMN IF NOT EXISTS explanation TEXT'),
            text("ALTER TABLE training_question ADD COLUMN IF NOT EXISTS difficulty VARCHAR(50) DEFAULT 'medio'"),
            text('''
